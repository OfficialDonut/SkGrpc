...
public class ExprTlsChannelCredentials extends SimpleExpression<ChannelCredentials> {
    ...
    static {
        Skript.registerExpression(ExprTlsChannelCredentials.class, ChannelCredentials.class, ExpressionType.SIMPLE, "(tls|ssl) [g]rpc channel credentials [cert:trusting [root] cert[ificate] %-string%]");
    }
